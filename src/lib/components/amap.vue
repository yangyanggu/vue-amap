  ...
  data() {
    return {
      handlers: {
        ...
        keyboardEnable(flag) {
          this.setStatus({keyboardEnable: flag});
        },
        doubleClickZoom(flag) {
          this.setStatus({doubleClickZoom: flag});
        },
        scrollWheel(flag) {
          this.setStatus({scrollWheel: flag});
        },
        rotateEnable(flag) {
          this.setStatus({rotateEnable: flag});
        },
        resizeEnable(flag) {
          this.setStatus({resizeEnable: flag});
        },
        showIndoorMap(flag) {
          this.setStatus({showIndoorMap: flag});
        }
      }
    };
  },
