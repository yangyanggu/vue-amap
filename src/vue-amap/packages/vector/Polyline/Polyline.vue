...
let $amapComponent: AMap.Polyline;

const {$$getInstance, parentInstance} = useRegister<AMap.Polyline, any>((options, parentComponent) => {
  return new Promise<AMap.Polyline>((resolve) => {
  ...
  return new Promise<void>((resolve) => {
    if (editor) {
      ...
      AMap.plugin(['AMap.PolylineEditor'], () => {
        editor = new AMap.PolylineEditor(parentInstance?.$amapComponent, $amapComponent, props.editOptions);
